 ...
 * types of methods in standard drawingÃ¢â‚¬â€�methods that draw geometric shapes and
 ...
 * <p>
 * <b>Saving to a file.</b> You save your image to a file using the <em>File Ã¢â€ â€™
 ...
 * call a drawing methodÃ¢â‚¬â€�such as {@code point()} or {@code line()}Ã¢â‚¬â€�the
 ...
 * segment from (0.5, Ã¢â‚¬â€œ10^308) to (0.5, 10^308) may not be visible even in the
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * ..., (<em>x</em><sub><em>n</em>Ã¢â‚¬â€œ1</sub>,
	 * <em>y</em><sub><em>n</em>Ã¢â‚¬â€œ1</sub>).
	 *
